...
Currently idle management is fully working but the screen locker does not yet function with Qtile running under Wayland but work to resolve this is currently under way.
